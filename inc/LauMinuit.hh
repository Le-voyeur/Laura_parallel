...
class LauMinuit : public LauAbsFitter<LauMinuit> {
    ...
    void twoStageFit_imp(Bool_t doTwoStageFit) {twoStageFit_ = doTwoStageFit;}

    //! Determine whether calculation of asymmetric errors is enabled
    //virtual Bool_t useAsymmFitErrors() const {return useAsymmFitErrors_;}
    Bool_t useAsymmFitErrors_imp() const {return useAsymmFitErrors_;}
    ...
    /*!
      ...
      */
      const LauAbsFitter<LauMinuit>::FitStatus& minimise_imp();
