    ...
    //! Access to the fit ntuple
		...
		*/
		...
		/*!
			...
			\param [in] tableFileName the file name for the latex output file
		*/
		void setupResultsOutputs( const TString& histFileName, const TString& tableFileName );
		...
		*/
		virtual void finaliseExperiment( const LauAbsFitter<LauMinuit>::FitStatus& fitStat, const TObjArray* parsFromMaster, const TMatrixD* covMat, TObjArray& parsToMaster );
