...
class LauFitObject : public TObject {
	...
	protected:
		...
		*/
		void storeFitStatus( const LauAbsFitter<LauMinuit>::FitStatus& status, const TMatrixD& covMatrix );
		...
		const LauAbsFitter<LauMinuit>::FitStatus& fitStatus() const {return fitStatus_;}
	...
	private:
		...
		LauAbsFitter<LauMinuit>::FitStatus fitStatus_;
